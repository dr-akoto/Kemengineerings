  ...
  head: () => ({
    meta: [
      { title: "Contact KEM Engineering & Design | Iron-City, Kasoa, Ghana" },
      {
        name: "description",
        content:
          "Visit our office in Iron-City, Kasoa or reach us by phone, WhatsApp or email. Free consultations for new engineering projects in Ghana.",
      },
      { property: "og:title", content: "Contact KEM Engineering & Design" },
      {
        property: "og:description",
        content: "Reach our engineering studio in Iron-City, Kasoa, Ghana.",
      },
      ...
      <section className="container-x grid lg:grid-cols-2 gap-10 pb-16">
        <div className="space-y-5">
          <a
            ...
            className="flex gap-4 p-5 rounded-xl border border-border hover:border-primary/50 transition"
          >
            <span className="grid place-items-center size-12 rounded-lg bg-primary/10 text-primary">
