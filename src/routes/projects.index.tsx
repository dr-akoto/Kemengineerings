  ...
  head: () => ({
    meta: [
      { title: "Projects & Portfolio | KEM Engineering & Design" },
      {
        name: "description",
        content:
          "Selected residential, commercial and structural engineering projects delivered across Ghana.",
      },
      { property: "og:title", content: "Projects | KEM Engineering & Design" },
      {
        property: "og:description",
        content:
          "Selected residential, commercial and structural engineering projects across Ghana.",
      },
