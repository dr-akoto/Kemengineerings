  ...
  head: () => ({
    meta: [
      { title: "Careers | KEM Engineering & Design | Kasoa, Ghana" },
      {
        name: "description",
        content:
          "Join a growing engineering studio in Ghana. Send us your CV — we're always interested in talented engineers, drafters and architects.",
      },
      ...
      <section className="container-x pb-24">
        <div className="glass rounded-2xl p-8 max-w-2xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Email your CV and a short note about your work to{" "}
            <a href="mailto:kemclassic7@icloud.com" className="text-primary">
              kemclassic7@icloud.com
            </a>
            . If there's a fit, we'll be in touch.
          </p>
          <Link
            to="/contact"
            className="mt-6 inline-flex items-center gap-2 rounded-md bg-[var(--gradient-gold)] px-5 py-3 text-sm font-semibold text-white"
          >
