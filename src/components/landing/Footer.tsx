      ...
      <div className="container-x py-16 grid md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <p className="mt-5 text-sm text-muted-foreground leading-relaxed max-w-xs">
            A premium civil engineering and construction design studio. Engineering landmark
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-sm text-muted-foreground">
            ...
            <li>
              <Link
                to="/services/$slug"
                params={{ slug: "structural-drawings" }}
                className="hover:text-primary transition"
              >
                Structural Drawings
              </Link>
            ...
            <li>
              <Link
                to="/services/$slug"
                params={{ slug: "architectural-design" }}
                className="hover:text-primary transition"
              >
            ...
            <li>
              <Link
                to="/services/$slug"
                params={{ slug: "construction-supervision" }}
                className="hover:text-primary transition"
              >
