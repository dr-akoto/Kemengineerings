  ...
  return (
    <section id="contact" className="relative section-y overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.14 0.04 260 / 0.95), oklch(0.16 0.03 255 / 0.85))",
        }}
      />
      ...
      <div className="container-x relative grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-5 text-base md:text-lg text-muted-foreground max-w-lg leading-relaxed">
            Whether it's a single-family build or a multi-story commercial project — let's design it
            together. Book a free 30-minute consultation today.
          </p>

          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <a
              href="tel:+233208450327"
              className="inline-flex items-center gap-3 rounded-md border border-border bg-card/40 backdrop-blur px-5 py-4 hover:border-primary/50 transition"
            >
          ...
          <a
            href="#contact-form"
            className="mt-8 inline-flex items-center gap-2 rounded-md bg-[var(--gradient-gold)] px-6 py-3.5 text-sm font-semibold text-primary-foreground hover:shadow-[var(--shadow-gold)] transition"
          >
